-- =====================================================
-- MASTER PIXEL HUB — V3.5 (CORRIGIDO PARA DELTA)
-- =====================================================
--  Sem modificação da tabela string (readonly fix)
-- =====================================================
...
-- =====================================================
-- FUNÇÃO SPLIT LOCAL (não modifica a tabela string)
-- =====================================================
...
Pixel 1 = FF0000 | Pixel 2 = 00FF00 | Pixel 3 = 0000FF
	...
	local function startSmartPaint(updateBar, setProgress)
		...
		if selectedMap:sub(1,4) == "ANIM" then
			local parts = splitString(selectedMap, "|")
			if #parts < 4 then
...
print("Master Pixel Hub V3.5 — corrigido para Delta — carregado.")
